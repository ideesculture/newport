...
function Model() {
	...
	this.init = function(_ca_table) {
		...
		var request = "CREATE TABLE IF NOT EXISTS " + _ca_table + " (id INTEGER PRIMARY KEY AUTOINCREMENT, ca_table TEXT, list_id INTEGER, id INTEGER, list_code TEXT, display_label TEXT, default_sort INTEGER, is_hierarchical INTEGER, is_system_list INTEGER, use_as_vocabulary INTEGER);";
		db.execute(request);
		db.close();
	};
